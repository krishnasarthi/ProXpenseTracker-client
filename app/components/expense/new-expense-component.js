(function () {
    ...
    function modalController(categoryService, subcategoryService, paymenttypeService, expenseService) {
        var vm = this;
        var defaultOption = [{ _id: -1, name: 'No category found' }];
        ...
        vm.save = function () {
            ...
            expenseService.savePayment(newPayment).then(
                function (response) {
    ...
    module.component('newExpense', {
        ...
        controller: ['categoryService', 'subcategoryService', 'paymenttypeService', 'expenseService', modalController]
    });
} ());