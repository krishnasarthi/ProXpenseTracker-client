(function () {
    ...
    function filterController(categoryService, subcategoryService, paymenttypeService) {
        var vm = this;
        var defaultCategory = { _id: -1, name: 'Category' };
        var defaultSubCategory = [{ _id: -1, name: 'Sub Category' }];
        var defaultPaymentType = { _id: -1, name: 'Payment Type' };
        ...
        vm.$onInit = function () {
            ...
            paymenttypeService.getPaymentType().then(
                function (response) {
        ...
        vm.getSubCategory = function () {
            subcategoryService.getSubCategoryByCategory(vm.category).then(
                function (response) {
    ...
    module.component('filter', {
        ...
        controller: ['categoryService', 'subcategoryService', 'paymenttypeService', filterController]
    });
} ());   